          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <div className="md:ml-auto">
              <div className="flex space-x-2">
                ...
                <a href="/index.html" className="text-white bg-black hover:bg-gray-900 hover:text-white rounded-md px-3 py-2"> Jobs</a>
                <a href="/index.html" className="text-white bg-black hover:bg-gray-900 hover:text-white rounded-md px-3 py-2"> Add Job</a>
              </div>
            </div>
          </div>
        </div>
